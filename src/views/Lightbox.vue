<template>
  <div>
    <p style="color: #00c3f5; padding-bottom: 5px; padding-left: 5px; font-size: 15px" class="demo-small-pitch">
      <!-- 参照 京东APP 和
      <a href="http://photoswipe.com/" style="text-decoration: underline;"
        >Photoswipe</a
      >
      功能实现。 -->
    </p>
    <lightbox>
      <div class="demo-lightbox">
        <div>
          <lightbox-img :src="img1" :original="img1"></lightbox-img>
        </div>
        <div>
          <div>
            <div>
              <lightbox-img :src="img2" :original="img2"></lightbox-img>
            </div>
            <div>
              <lightbox-img :src="img3" :original="img3"></lightbox-img>
            </div>
          </div>
          <div>
            <div>
              <lightbox-img :src="img4" :original="img4"></lightbox-img>
            </div>
            <div>
              <lightbox-img :src="img5" :original="img5"></lightbox-img>
            </div>
          </div>
        </div>
      </div>
...
<script>
import img1 from '../assets/scenery_s01.jpg'
import img2 from '../assets/scenery_s02.jpg'
