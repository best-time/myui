  ...
  <div class="home">
    ...
    <div class="demo-rollnotice">
      ...
      <rollnotice autoplay="2000">
        <rollnotice-item><span style="color: #f00">&nbsp;荐&nbsp;</span>荣耀V9 3月超级钜惠！</rollnotice-item>
        <rollnotice-item><span style="color: #f00">&nbsp;荐&nbsp;</span>3.23京东超级品牌日格力盛典</rollnotice-item>
        <rollnotice-item><span style="color: #f00">&nbsp;荐&nbsp;</span>京东服饰 早春新品低至7折</rollnotice-item>
      </rollnotice>
    </div>
