...
const routeList = [
	...
	{name: 'defineComponent', component: () => import('../views/defineComponent/index.vue')},
	{name: 'domStyle', component: () => import('../views/domStyle/index.vue')},
	{name: 'headerScroll', component: () => import('../views/tableHeaderScroll/index.vue')},
	{name: 'testFun', component: () => import('../views/func/index.vue')},
	{name: 'login', component: () => import('../views/login/index.vue')},
	{name: 'timeline', component: () => import('../views/login/timeLine.vue')},
	{name: 'upload', component: () => import('../views/login/upload.vue')},
	{name: 'tablet', component: () => import('../views/login/table.vue')},
	{name: 'canvastable', component: () => import('../views/login/canvas/app.vue')},
	{name: 'loginTest', component: () => import('../views/login/test.vue')},
