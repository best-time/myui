...
export type GeneratePropsType<Element, Override = { children: any }, Target = InheritAttributes<Element>> = Partial<
  Omit<Override & Target & _ConvertTarget<Target>, 'className' | 'class'> & { className: any; class: any }
>
