...
function __computed<T>(
  options: WritableComputedOptions<T>,
  debugOptions?: DebuggerOptions
): iPlainWritableComputedRef<T>
...
export type iPlainComputedRef<T> = Omit<ComputedRef<T>, 'effect'> & {
  effect: { stop: () => void } & ComputedRefImpl<T>
}
export type iPlainWritableComputedRef<T> = Omit<WritableComputedRef<T>, 'effect'> & {
  effect: { stop: () => void } & ComputedRefImpl<T>
}
