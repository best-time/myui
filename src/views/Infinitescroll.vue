<template>
  <div>
    <div style="height: 40px; background-color: #eee">infinitescroll</div>

    <infinitescroll :on-infinite="loadList" ref="lsdemo">
      <list theme="1" slot="list">
        <list-item :key="idx" v-for="(item, idx) in list">
