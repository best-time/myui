...
![img_27.png](imgs/img2/img_27.png)
...
![img_30.png](imgs/img2/img_30.png)
  ...
  const service = createServer((socket) => {
    ...
    socket.on('data', (data) => {
      ...
      if (result.body.method === 'jump') return
        ...
        socket.write(encodeBuf(1, result.requestId, { code: 200, msg: 'success' }))
      }
    })
...
返回结果
![img_31.png](imgs/img2/img_31.png)
