...
export const isArray = (p: any): boolean => (Array.isArray ? Array.isArray(p) : toStr.call(p) === '[object Array]')
export const isString = (s: any): boolean => typeof s === 'string'
export const isFunction = (p: any): boolean => toStr.call(p) === '[object Function]'
