...
<script>
// import {isequal as _isequal, set as _set, clonedeep as _clonedeep} from 'lodash'
...
export default {
  ...
  methods: {
    ...
    setValueFromModel() {
      ...
      if (!_.isEqual(this.value, newValue)) this.value = newValue
    },
    /**
     * 更新表单数据
